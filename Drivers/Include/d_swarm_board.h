...
#define UART_RX_PIN NRF_GPIO_PIN_MAP(1, 0)
#define UART_TX_PIN NRF_GPIO_PIN_MAP(1, 1)
#define UART_CTS_PIN NRF_GPIO_PIN_MAP(1, 2)
#define UART_RTS_PIN NRF_GPIO_PIN_MAP(1, 3)
